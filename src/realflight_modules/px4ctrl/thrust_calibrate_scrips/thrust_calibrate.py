...
class ThrustCalibration:
    ...
    def __init__(self):
        ...
        #     "typhoon_h480_0/mavros/battery", BatteryState, self.battery_voltage_cb)
        rospy.Subscriber(
            "typhoon_h480_0/mavros/setpoint_raw/attitude", AttitudeTarget, self.thrust_commands_cb)
        rospy.Subscriber(
